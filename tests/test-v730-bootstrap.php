...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.7.1') !== false,
    'runtime version' => strpos($main, "const VERSION = '7.7.1';") !== false,
