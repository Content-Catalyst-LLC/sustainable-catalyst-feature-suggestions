...
$checks = array(
    'main version is 5.1.0' => Sustainable_Catalyst_Feature_Suggestions::VERSION === '5.2.7',
    'integrated Knowledge Base class loaded' => class_exists('SCFS_Integrated_Knowledge_Base'),
    'integrated Knowledge Base version' => SCFS_Integrated_Knowledge_Base::VERSION === '5.2.7',
