...
$checks = array(
    'feature manifest version' => ($manifest['version'] ?? '') === '7.0.0',
    'feature manifest release name' => ($manifest['release_name'] ?? '') === 'Connected Help Desk and Support Operations Platform',
