...
foreach (array('VERSION = "7.5.5"','DIAGNOSTICS_SCHEMA','normalize_plugin_version','preferred_match','legacy_plugin_file','legacy_plugin_slug','legacy_text_domain','network_active_match_count','malformed_version_count') as $needle) {
...
echo "v7.5.5 backend compatibility contract passed.\n";
