...
$checks = array(
    'feature manifest version' => ($manifest['version'] ?? '') === '5.5.0',
    'feature manifest release name' => ($manifest['release_name'] ?? '') === 'Support Content Operations and Editorial Governance',
