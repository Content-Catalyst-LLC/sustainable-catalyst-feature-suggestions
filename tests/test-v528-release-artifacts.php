...
$checks = array(
    'feature manifest version' => ($manifest['version'] ?? '') === '6.9.0',
    'feature manifest release name' => ($manifest['release_name'] ?? '') === 'Quality Assurance, Analytics, and Support Intelligence',
