...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 5.2.9') !== false,
    'main version constant' => strpos($main, "const VERSION = '5.2.9';") !== false,
    'knowledge base version' => strpos($knowledge, "const VERSION = '5.2.9';") !== false,
    'integrated knowledge base version' => strpos($integrated, "const VERSION = '5.2.9';") !== false,
