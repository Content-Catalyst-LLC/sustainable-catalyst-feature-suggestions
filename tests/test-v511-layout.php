...
$checks = array(
    ...
    'main version constant' => strpos($main, "const VERSION = '5.2.8';") !== false,
    'knowledge base version' => strpos($knowledge, "const VERSION = '5.2.8';") !== false,
    'integrated knowledge base version' => strpos($integrated, "const VERSION = '5.2.8';") !== false,
    ...
    'release notes exist' => file_exists($root . '/RELEASE_NOTES_5.2.8.md'),
);
