...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 5.2.5') !== false,
    'main version constant' => strpos($main, "const VERSION = '5.2.5';") !== false,
    'knowledge base version' => strpos($knowledge, "const VERSION = '5.2.5';") !== false,
    'integrated knowledge base version' => strpos($integrated, "const VERSION = '5.2.5';") !== false,
    ...
    'release notes exist' => file_exists($root . '/RELEASE_NOTES_5.2.5.md'),
);
