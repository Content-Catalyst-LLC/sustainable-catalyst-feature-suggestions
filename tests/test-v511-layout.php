...
$checks = array(
    ...
    'knowledge base version' => strpos($knowledge, "const VERSION = '5.2.4';") !== false,
    'integrated knowledge base version' => strpos($integrated, "const VERSION = '5.2.4';") !== false,
    ...
    'release notes exist' => file_exists($root . '/RELEASE_NOTES_5.2.4.md'),
);
