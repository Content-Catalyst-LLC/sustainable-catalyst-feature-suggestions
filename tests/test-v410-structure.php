...
$checks = array(
    'plugin version' => strpos($main, 'Version: 5.5.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '5.5.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.5.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Support Content Operations and Editorial Governance',
