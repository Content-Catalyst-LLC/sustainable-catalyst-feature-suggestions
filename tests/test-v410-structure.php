...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.5.5') !== false,
    'runtime version' => strpos($main, "const VERSION = '7.5.5';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.5.5',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'GitHub Tag Fallback and Unified Console Administration',
