...
$checks = array(
    'plugin version' => strpos($main, 'Version: 4.2.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '4.2.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '4.2.0',
