...
$checks = array(
    'plugin version' => strpos($main, 'Version: 4.3.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '4.3.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '4.3.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Documentation Workflow and Editorial Governance',
