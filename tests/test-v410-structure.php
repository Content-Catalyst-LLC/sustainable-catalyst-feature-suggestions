...
$checks = array(
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.5.4',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Administrator GitHub Connection and Console Link Controls',
