...
$checks = array(
    'plugin version' => strpos($main, 'Version: 4.4.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '4.4.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '4.4.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Support Analytics and Product Reliability Center',
