...
$checks = array(
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.2.1',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Discovery and Compatibility Patch',
