...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.6.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '7.6.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.6.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Release Operations Administration and Sync Governance',
