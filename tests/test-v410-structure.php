...
$checks = array(
    'plugin version' => strpos($main, 'Version: 5.4.0') !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.4.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Known Issues and Release Intelligence Integration',
