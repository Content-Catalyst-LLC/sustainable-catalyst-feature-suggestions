...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.2.0') !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.2.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Installed Plugin Discovery',
