...
$checks = array(
    'plugin version' => strpos($main, 'Version: 6.2.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '6.2.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '6.2.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Agent Workspace, Queues, and Assignment',
