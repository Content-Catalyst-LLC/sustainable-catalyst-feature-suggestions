...
$checks = array(
    'plugin version' => strpos($main, 'Version: 5.3.0') !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.3.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Unified Search and Guided Resolution',
