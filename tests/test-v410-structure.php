...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.0.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '7.0.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.0.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Connected Help Desk and Support Operations Platform',
