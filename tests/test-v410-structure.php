...
$checks = array(
    'plugin version' => strpos($main, 'Version: 6.3.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '6.3.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '6.3.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Customer Support Portal and Conversations',
