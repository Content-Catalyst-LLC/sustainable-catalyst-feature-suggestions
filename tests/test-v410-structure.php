...
$checks = array(
    'plugin version' => strpos($main, 'Version: 4.1.1') !== false,
    'runtime version' => strpos($main, "const VERSION = '4.1.1';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '4.1.1',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Content Operations Reliability Patch',
