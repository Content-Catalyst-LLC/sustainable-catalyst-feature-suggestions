...
$checks = array(
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.2.3',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Dynamic Documentation Records, Permalink Integrity, and Knowledge Base Interface Refinement',
