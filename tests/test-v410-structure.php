...
$checks = array(
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.2.7',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Support Center Production Integration and Interface Hardening',
