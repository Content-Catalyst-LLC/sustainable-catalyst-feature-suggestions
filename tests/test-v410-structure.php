...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.5.3') !== false,
    'runtime version' => strpos($main, "const VERSION = '7.5.3';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.5.3',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Active Plugin and GitHub Console Connections',
