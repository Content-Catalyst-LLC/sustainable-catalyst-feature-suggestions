...
$checks = array(
    ...
    'runtime version' => strpos($main, "const VERSION = '5.2.4';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.2.4',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Knowledge Base Route Integrity and Dedicated Page Recovery',
