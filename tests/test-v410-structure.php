...
$checks = array(
    'plugin version' => strpos($main, 'Version: 7.0.1') !== false,
    'runtime version' => strpos($main, "const VERSION = '7.0.1';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.0.1',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Repository Identity Migration',
