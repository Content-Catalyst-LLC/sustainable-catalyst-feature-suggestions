...
$checks = array(
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '7.3.3',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Release Console Reliability and Presentation Repair',
