...
$checks = array(
    'plugin version' => strpos($main, 'Version: 6.10.0') !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '6.10.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Institutional Workspaces and Access Governance',
