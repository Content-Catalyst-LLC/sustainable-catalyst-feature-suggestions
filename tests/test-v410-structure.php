...
$checks = array(
    'plugin version' => strpos($main, 'Version: 5.2.0') !== false,
    'runtime version' => strpos($main, "const VERSION = '5.2.0';") !== false,
    ...
    'manifest version' => is_array($manifest) && ($manifest['version'] ?? '') === '5.2.0',
    'manifest release name' => is_array($manifest) && ($manifest['release_name'] ?? '') === 'Support Documentation Library and Expandable Category Index',
