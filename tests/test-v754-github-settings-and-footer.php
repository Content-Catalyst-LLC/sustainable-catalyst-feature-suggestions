...
$checks = array(
    'runtime identity' => strpos($main, 'Version: 7.8.0') !== false && strpos($main, "const VERSION = '7.8.0';") !== false,
...
echo 'v7.8.0 GitHub settings and footer controls contract passed (' . count($checks) . " checks).\n";
