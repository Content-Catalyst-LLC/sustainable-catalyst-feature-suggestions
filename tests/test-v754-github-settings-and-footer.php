...
$checks = array(
    'runtime identity' => strpos($main, 'Version: 7.6.1') !== false && strpos($main, "const VERSION = '7.6.1';") !== false,
...
echo 'v7.6.1 GitHub settings and footer controls contract passed (' . count($checks) . " checks).\n";
