...
$good = $ops->validate_import_record(array('type'=>'article','title'=>'Workbench v5.1.0 Guide','content'=>'Useful'), 2);
$checks = array(
    ...
    'version-insensitive title normalization' => $ops->normalize_title('Workbench v5.1.0 Guide') === $ops->normalize_title('Workbench v5.1.0 Guide'),
);
