...
$good = $ops->validate_import_record(array('type'=>'article','title'=>'Workbench v4.5.0 Guide','content'=>'Useful'), 2);
$checks = array(
    ...
    'version-insensitive title normalization' => $ops->normalize_title('Workbench v4.5.0 Guide') === $ops->normalize_title('Workbench v4.5.0 Guide'),
);
