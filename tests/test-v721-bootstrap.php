...
$checks = array(
    ...
    'discovery version' => strpos($discovery, "const VERSION = '7.2.1';") !== false,
    'registry version' => strpos($registry, "const VERSION = '7.2.1';") !== false,
...
echo "v7.2.1 bootstrap contract passed.\n";
