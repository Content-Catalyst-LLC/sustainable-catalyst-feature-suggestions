...
foreach(array('VERSION = "7.3.1"','scfs-help-desk-knowledge-resolution/1.0','evaluate_resolution','evaluate_similar_cases','evaluate_agent_decision','evaluate_guided_plan','evaluate_promotion') as $needle){if(strpos($module,$needle)===false){fwrite(STDERR,"FAIL backend: $needle\n");exit(1);}}
