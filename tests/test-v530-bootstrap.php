...
$checks = array(
    'plugin header version' => strpos($main, 'Version: 5.3.0') !== false,
    ...
    'unified class version' => strpos($class, "const VERSION = '5.3.0';") !== false,
...
echo 'v5.3.0 unified support bootstrap contract passed (' . count($checks) . " checks).\n";
