...
$checks = array(
    'backend version' => strpos($module, 'VERSION = "7.4.0"') !== false,
    'backend schema' => strpos($module, 'SCHEMA = "scfs-release-board/1.2"') !== false,
...
echo "v7.4.0 Release Console backend contract passed.\n";
