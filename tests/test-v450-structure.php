...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 4.5.0') !== false,
    'main version constant' => strpos($main, "const VERSION = '4.5.0';") !== false,
    ...
    'orchestration class version' => strpos($class, "const VERSION = '4.5.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '4.5.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Cross-Product Support Orchestration',
