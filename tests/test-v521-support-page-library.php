...
$checks = array(
  ...
  'compact library CSS' => strpos($css, 'v5.2.3 Dynamic records, permalink integrity, refined full browser') !== false,
...
echo 'v5.2.3 support page library contract passed (' . count($checks) . " checks).\n";
