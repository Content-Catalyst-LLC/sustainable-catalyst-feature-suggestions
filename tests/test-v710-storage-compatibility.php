...
$checks = array(
    ...
    'nonautoload seed' => strpos($class, 'add_option(self::OPTION_KEY, $instance->default_products(), \'\', false)') !== false,
...
echo "v7.2.0 registry storage and WordPress compatibility contract passed.\n";
