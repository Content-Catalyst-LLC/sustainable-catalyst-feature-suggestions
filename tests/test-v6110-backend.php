...
");exit(1);}}foreach(array('VERSION = "7.3.0"','evaluate_api_scope','evaluate_webhook_subscription','sign_webhook_delivery','evaluate_delivery_retry','evaluate_external_link','evaluate_integration_privacy','verify_integration_report') as $needle){if(strpos($module,$needle)===false){fwrite(STDERR,"FAIL backend: $needle
