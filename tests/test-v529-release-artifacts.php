...
$checks = array(
    'feature manifest version' => ($manifest['version'] ?? '') === '7.6.0',
    'feature manifest release name' => ($manifest['release_name'] ?? '') === 'Release Operations Administration and Sync Governance',
