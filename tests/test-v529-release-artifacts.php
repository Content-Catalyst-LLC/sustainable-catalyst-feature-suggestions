...
$checks = array(
    'feature manifest version' => ($manifest['version'] ?? '') === '7.5.5',
    'feature manifest release name' => ($manifest['release_name'] ?? '') === 'GitHub Tag Fallback and Unified Console Administration',
