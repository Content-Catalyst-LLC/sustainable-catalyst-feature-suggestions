...
if (($release['version'] ?? '') !== '7.5.3' || empty($release['validation']['release_console_default'])) { fwrite(STDERR, "FAIL release manifest\n"); exit(1); }
echo "v7.5.3 Release Console artifact contract passed.\n";
