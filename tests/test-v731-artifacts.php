...
if (($release['version'] ?? '') !== '7.7.1' || empty($release['validation']['release_console_default'])) { fwrite(STDERR, "FAIL release manifest\n"); exit(1); }
echo "v7.7.1 Release Console artifact contract passed.\n";
