...
if (($release['version'] ?? '') !== '7.5.4' || empty($release['validation']['release_console_default'])) { fwrite(STDERR, "FAIL release manifest\n"); exit(1); }
echo "v7.5.4 Release Console artifact contract passed.\n";
