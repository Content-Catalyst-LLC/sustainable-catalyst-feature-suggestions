...
if (($release['version'] ?? '') !== '7.8.0' || empty($release['validation']['release_console_default'])) { fwrite(STDERR, "FAIL release manifest\n"); exit(1); }
echo "v7.8.0 Release Console artifact contract passed.\n";
