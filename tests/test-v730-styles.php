...
$css = file_get_contents($root . '/wordpress/sustainable-catalyst-feature-suggestions/assets/release-board-v7.3.0.css');
$checks = array(
    'scoped stylesheet' => strpos($css, '.scfs-release-board') !== false,
    'blackboard surface' => strpos($css, '--scfs-board-bg: #101112') !== false,
    ...
    'container fallback' => strpos($css, '@container (max-width: 760px)') !== false,
...
echo "v7.3.0 release board stylesheet contract passed.\n";
