...
$checks = array(
 'plugin header version' => strpos($main, 'Version: 6.2.0') !== false,
 ...
 'class version' => strpos($class, "const VERSION = '6.2.0';") !== false,
...
echo 'v6.2.0 bootstrap contract passed (' . count($checks) . " checks).\n";
