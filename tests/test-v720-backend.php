...
foreach (array('VERSION = "7.3.3"','SCHEMA = "scfs-installed-plugin-discovery/1.0"','PluginDiscoveryEvidence','PluginDiscoveryAssessment','validate_plugin_discovery','discovery_capabilities') as $needle) {
...
echo "v7.3.3 installed plugin discovery backend contract passed.
";
