...
$checks = array(
    ...
    'main version constant' => strpos($main, "const VERSION = '5.2.3';") !== false,
    ...
    'integrated class version' => strpos($integrated, "const VERSION = '5.2.3';") !== false,
    'dynamic documentation directory' => strpos($integrated, 'filtered_articles') !== false && strpos($integrated, 'scfs-kb-refined__categories') !== false,
    'product navigator and compact category folders' => strpos($integrated, 'scfs-kb-refined__products') !== false && strpos($integrated, 'scfs-support-library-compact__topic') !== false,
