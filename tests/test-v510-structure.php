...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 5.2.0') !== false,
    'main version constant' => strpos($main, "const VERSION = '5.2.0';") !== false,
    ...
    'integrated class version' => strpos($integrated, "const VERSION = '5.2.0';") !== false,
    'expandable directory' => strpos($integrated, 'Browse by category') !== false && strpos($integrated, 'scfs-support-library-category') !== false,
    'nested product folders' => strpos($integrated, 'scfs-kb-product-folder') !== false && strpos($integrated, 'scfs-kb-section-folder') !== false,
    'search and product filters' => strpos($integrated, 'Search documentation') !== false && strpos($integrated, 'scfs_kb_product') !== false,
    'article breadcrumbs' => strpos($integrated, 'scfs-kb-breadcrumbs') !== false,
    'article sequencing' => strpos($integrated, 'scfs-kb-article-sequence') !== false,
    'related guides' => strpos($integrated, 'Related guides') !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '5.2.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Support Documentation Library and Expandable Category Index',
