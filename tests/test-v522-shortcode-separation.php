...
$checks = array(
    ...
    'library parity compact css' => strpos($css, 'v5.2.4 Dynamic records, permalink integrity, refined full browser') !== false,
...
echo 'v5.2.4 shortcode separation contract passed (' . count($checks) . " checks).\n";
