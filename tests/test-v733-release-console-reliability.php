...
$js = file_get_contents($plugin . '/assets/release-console-v7.7.1.js');
$checks = array(
    'runtime version' => strpos($board, "const VERSION = '7.7.1';") !== false,
    'v733 assets' => strpos($board, 'release-board-v7.7.1.css') !== false && strpos($board, 'release-console-v7.7.1.js') !== false,
...
echo "v7.7.1 Release Console reliability and presentation contract passed.\n";
