...
$css = file_get_contents($plugin . '/assets/release-board-v7.3.3.css');
$js = file_get_contents($plugin . '/assets/release-console-v7.3.3.js');
$checks = array(
    'runtime version' => strpos($board, "const VERSION = '7.3.3';") !== false,
    'v733 assets' => strpos($board, 'release-board-v7.3.3.css') !== false && strpos($board, 'release-console-v7.3.3.js') !== false,
...
echo "v7.3.3 Release Console reliability and presentation contract passed.\n";
