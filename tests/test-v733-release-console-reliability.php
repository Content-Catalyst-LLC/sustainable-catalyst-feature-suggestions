...
$js = file_get_contents($plugin . '/assets/release-console-v7.6.0.js');
$checks = array(
    'runtime version' => strpos($board, "const VERSION = '7.6.0';") !== false,
    'v733 assets' => strpos($board, 'release-board-v7.6.0.css') !== false && strpos($board, 'release-console-v7.6.0.js') !== false,
...
echo "v7.6.0 Release Console reliability and presentation contract passed.\n";
