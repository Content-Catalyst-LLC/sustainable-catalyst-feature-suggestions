...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 4.3.0') !== false,
    'main version constant' => strpos($main, "const VERSION = '4.3.0';") !== false,
    ...
    'governance class version' => strpos($class, "const VERSION = '4.3.0';") !== false,
    ...
    'backend module version' => strpos($backend, 'version: str = "4.3.0"') !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '4.3.0',
