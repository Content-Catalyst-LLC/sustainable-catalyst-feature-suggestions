...
foreach (array('VERSION = "7.3.3"','SCHEMA = "scfs-canonical-product-registry/1.1"','ProductRegistryRecord','validate_product_registry','DEFAULT_PRODUCT_IDS') as $needle) {
...
echo "v7.3.3 canonical product registry backend contract passed.\n";
