...
foreach (array('VERSION = "7.1.0"','SCHEMA = "scfs-canonical-product-registry/1.0"','ProductRegistryRecord','validate_product_registry','DEFAULT_PRODUCT_IDS') as $needle) {
...
echo "v7.1.0 canonical product registry backend contract passed.\n";
