...
foreach (array('VERSION = "7.6.1"','SCHEMA = "scfs-canonical-product-registry/2.0"','ProductRegistryRecord','validate_product_registry','DEFAULT_PRODUCT_IDS') as $needle) {
...
echo "v7.6.1 canonical product registry backend contract passed.\n";
