...
$css = file_get_contents($plugin . '/assets/product-connection-editor-v7.6.2.css');
$js = file_get_contents($plugin . '/assets/product-connection-editor-v7.6.2.js');
$checks = array(
    'runtime identity' => strpos($main, 'Version: 7.6.2') !== false && strpos($editor, "const VERSION = '7.6.2'") !== false,
...
echo 'v7.6.2 Product Connection Editor contract passed (' . count($checks) . " checks).\n";
