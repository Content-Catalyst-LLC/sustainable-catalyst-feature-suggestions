...
$checks = array(
    'runtime version' => strpos($main, 'Version: 7.5.4') !== false && strpos($main, "const VERSION = '7.5.4';") !== false,
...
echo "v7.5.4 active plugin, GitHub, and Release Console connection contract passed (" . count($checks) . " checks).\n";
