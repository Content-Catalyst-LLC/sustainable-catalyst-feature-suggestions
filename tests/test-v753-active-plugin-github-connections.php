...
$checks = array(
    'runtime version' => strpos($main, 'Version: 7.7.0') !== false && strpos($main, "const VERSION = '7.7.0';") !== false,
...
echo "v7.7.0 active plugin, GitHub, and Release Console connection contract passed (" . count($checks) . " checks).\n";
