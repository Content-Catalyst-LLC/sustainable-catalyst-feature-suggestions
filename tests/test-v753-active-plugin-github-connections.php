...
$checks = array(
    'runtime version' => strpos($main, 'Version: 7.5.5') !== false && strpos($main, "const VERSION = '7.5.5';") !== false,
...
echo "v7.5.5 active plugin, GitHub, and Release Console connection contract passed (" . count($checks) . " checks).\n";
