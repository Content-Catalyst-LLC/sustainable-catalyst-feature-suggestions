...
$checks = array(
    'runtime version' => strpos($main, 'Version: 7.6.0') !== false && strpos($main, "const VERSION = '7.6.0';") !== false,
...
echo "v7.6.0 active plugin, GitHub, and Release Console connection contract passed (" . count($checks) . " checks).\n";
