...
$js = file_get_contents($plugin . '/assets/plugin-discovery-v7.6.1.js');
...
$checks = array(
    'discovery version' => strpos($discovery, "const VERSION = '7.6.1';") !== false,
    ...
    'manifest identity' => ($manifest['version'] ?? '') === '7.6.1' && ($manifest['release_name'] ?? '') === 'Release Operations Stabilization',
...
echo "v7.6.1 canonical plugin mapping workflow contract passed (" . count($checks) . " checks).\n";
