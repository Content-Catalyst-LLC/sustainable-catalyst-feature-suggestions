...
$js = file_get_contents($plugin . '/assets/plugin-discovery-v7.5.3.js');
...
$checks = array(
    'discovery version' => strpos($discovery, "const VERSION = '7.5.3';") !== false,
    ...
    'manifest identity' => ($manifest['version'] ?? '') === '7.5.3' && ($manifest['release_name'] ?? '') === 'Active Plugin and GitHub Console Connections',
...
echo "v7.5.3 canonical plugin mapping workflow contract passed (" . count($checks) . " checks).\n";
