...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.5.5') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.5.5';") !== false,
...
echo "v7.5.5 WordPress compatibility contract passed.\n";
