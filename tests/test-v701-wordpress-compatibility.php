...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.4.0') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.4.0';") !== false,
...
echo "v7.4.0 WordPress compatibility contract passed.\n";
