...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.7.0') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.7.0';") !== false,
...
echo "v7.7.0 WordPress compatibility contract passed.\n";
