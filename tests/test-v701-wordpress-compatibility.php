...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.7.1') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.7.1';") !== false,
...
echo "v7.7.1 WordPress compatibility contract passed.\n";
