...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.6.1') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.6.1';") !== false,
...
echo "v7.6.1 WordPress compatibility contract passed.\n";
