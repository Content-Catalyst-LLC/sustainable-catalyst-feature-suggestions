...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.3.1') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.3.1';") !== false,
...
echo "v7.3.1 WordPress compatibility contract passed.\n";
