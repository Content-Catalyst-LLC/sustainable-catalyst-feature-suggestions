...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.6.0') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.6.0';") !== false,
...
echo "v7.6.0 WordPress compatibility contract passed.\n";
