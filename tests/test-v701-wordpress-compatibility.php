...
$checks = array(
    ...
    'plugin version bumped' => strpos($main, 'Version: 7.8.0') !== false,
    'runtime version bumped' => strpos($main, "const VERSION = '7.8.0';") !== false,
...
echo "v7.8.0 WordPress compatibility contract passed.\n";
