...
$js = file_get_contents($root . '/wordpress/sustainable-catalyst-feature-suggestions/assets/release-console-v7.7.1.js');
...
echo "v7.7.1 Product Connection Editor contract passed.\n";
