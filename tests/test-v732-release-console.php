...
$js = file_get_contents($root . '/wordpress/sustainable-catalyst-feature-suggestions/assets/release-console-v7.8.0.js');
...
echo "v7.8.0 Product Connection Editor contract passed.\n";
