...
$files = array(
    ...
    'docs/release-console-v7.5.4.md',
    'docs/release-board-shortcode-v7.5.4.md',
    'docs/release-telemetry-v7.5.4.md',
    'examples/release-board-v7.5.4.json',
    'examples/release-console-v7.5.4.json',
    'examples/release-telemetry-v7.5.4.json',
...
if (($current['version'] ?? '') !== '7.5.4' || ($current['release_name'] ?? '') !== 'Administrator GitHub Connection and Console Link Controls') { fwrite(STDERR, "FAIL manifest identity\n"); exit(1); }
...
if (($release['version'] ?? '') !== '7.5.4' || empty($release['validation']['stable_screen_height']) || empty($release['validation']['multiple_instances_supported'])) { fwrite(STDERR, "FAIL release manifest\n"); exit(1); }
if (($schema['properties']['version']['const'] ?? '') !== '7.5.4') { fwrite(STDERR, "FAIL schema version\n"); exit(1); }
echo "v7.5.4 release artifacts contract passed.\n";
