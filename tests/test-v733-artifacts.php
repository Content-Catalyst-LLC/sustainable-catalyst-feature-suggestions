...
$files = array(
    ...
    'examples/release-console-v7.5.0.json',
...
if (($release['version'] ?? '') !== '7.5.0' || empty($release['validation']['stable_screen_height']) || empty($release['validation']['multiple_instances_supported'])) { fwrite(STDERR, "FAIL release manifest\n"); exit(1); }
if (($schema['properties']['version']['const'] ?? '') !== '7.5.0') { fwrite(STDERR, "FAIL schema version\n"); exit(1); }
echo "v7.5.0 release artifacts contract passed.\n";
