...
$checks = array(
    'custom article header' => strpos($php, 'scfs-kb-publication-header') !== false,
    'custom article title' => strpos($php, 'scfs-kb-publication-header') !== false && strpos($php, '<h1>') !== false,
    'article summary' => strpos($php, 'scfs-kb-publication-deck') !== false,
    ...
    'refined category tabs' => strpos($php, 'scfs-kb-library-nav-group') !== false && strpos($php, 'scfs_kb_section') !== false,
);
