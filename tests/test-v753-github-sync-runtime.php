...
$GLOBALS['scfs_http'][$base . '/releases?per_page=1'] = array('response' => array('code' => 200), 'body' => json_encode(array(array('tag_name' => 'v7.7.0', 'name' => 'Product Connection Editor', 'html_url' => 'https://github.com/Content-Catalyst-LLC/sustainable-catalyst-product-support-feedback/releases/tag/v7.7.0', 'published_at' => '2026-07-22T22:05:00Z', 'draft' => false, 'prerelease' => false))));
...
$checks = array(
    'public version' => ($result['public_version'] ?? '') === '7.7.0',
    ...
    'release URL' => ($result['github_latest_release_url'] ?? '') === 'https://github.com/Content-Catalyst-LLC/sustainable-catalyst-product-support-feedback/releases/tag/v7.7.0',
...
echo "v7.7.0 GitHub-to-console runtime synchronization passed (" . count($checks) . " checks).\n";
