...
$checks = array(
    ...
    'runtime version constant' => strpos($main, "const VERSION = '7.2.1';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.2.1',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Discovery and Compatibility Patch',
