...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 6.6.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '6.6.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '6.6.0',
