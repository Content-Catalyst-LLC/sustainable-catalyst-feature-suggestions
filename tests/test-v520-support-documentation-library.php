...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.5.3') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.5.3';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.5.3',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Active Plugin and GitHub Console Connections',
