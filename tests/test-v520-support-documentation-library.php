...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.4.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.4.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.4.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Product Registry Governance',
