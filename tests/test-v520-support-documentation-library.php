...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.0.1') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.0.1';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.0.1',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Repository Identity Migration',
