...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 6.0.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '6.0.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '6.0.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Connected Product Support and Feedback Platform',
