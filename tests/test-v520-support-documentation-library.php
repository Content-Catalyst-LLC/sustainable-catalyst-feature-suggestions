...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 5.8.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '5.8.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '5.8.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Cross-Product Support Graph and Platform Handoffs',
