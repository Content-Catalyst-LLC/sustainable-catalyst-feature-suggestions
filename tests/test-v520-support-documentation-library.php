...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.5.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.5.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.5.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Release Intelligence and Console Copy Controls',
