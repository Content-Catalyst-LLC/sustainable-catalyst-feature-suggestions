...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.3.3') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.3.3';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.3.3',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Release Console Reliability and Presentation Repair',
