...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.7.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.7.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '7.7.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Canonical Product Registry Administration',
