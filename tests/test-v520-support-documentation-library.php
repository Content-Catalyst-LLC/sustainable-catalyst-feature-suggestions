...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 6.12.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '6.12.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '6.12.0',
