...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 5.9.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '5.9.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '5.9.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Public API, Embeds, and Institutional Support Integration',
