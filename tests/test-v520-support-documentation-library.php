...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 6.2.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '6.2.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '6.2.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Agent Workspace, Queues, and Assignment',
