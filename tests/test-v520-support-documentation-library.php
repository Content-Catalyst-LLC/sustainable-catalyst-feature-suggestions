...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 5.5.0') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '5.5.0';") !== false,
    ...
    'manifest version' => ($manifest['version'] ?? '') === '5.5.0',
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Support Content Operations and Editorial Governance',
