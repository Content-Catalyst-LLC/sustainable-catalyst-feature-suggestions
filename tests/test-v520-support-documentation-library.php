...
$checks = array(
    'plugin version header' => strpos($main, 'Version: 7.6.1') !== false,
    'runtime version constant' => strpos($main, "const VERSION = '7.6.1';") !== false,
    ...
    'manifest release name' => ($manifest['release_name'] ?? '') === 'Release Operations Stabilization',
