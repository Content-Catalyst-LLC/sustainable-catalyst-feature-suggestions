...
$css = file_get_contents($root . '/wordpress/sustainable-catalyst-feature-suggestions/assets/release-board-v7.6.0.css');
$checks = array(
...
echo "v7.6.0 Release Console stylesheet contract passed.\n";
