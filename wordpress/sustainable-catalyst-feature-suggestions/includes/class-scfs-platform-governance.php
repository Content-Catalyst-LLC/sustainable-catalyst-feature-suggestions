...
final class SCFS_Platform_Governance {
    ...
    private function module_status() {
        ...
        return array(
            ...
            'support_reliability' => array('label'=>'Product reliability','ready'=>class_exists('SCFS_Support_Reliability_Center'),'detail'=>'Resolution, documentation, issue, release, content, repository, and governance health intelligence'),
            'cross_product_orchestration' => array('label'=>'Cross-product support','ready'=>class_exists('SCFS_Cross_Product_Support_Orchestration') && post_type_exists(SCFS_Cross_Product_Support_Orchestration::INCIDENT_POST_TYPE),'detail'=>'Platform incidents, dependency-aware support routes, shared components, and cross-product resolution journeys'),
            'connected_support_operations' => array('label'=>'Connected support operations','ready'=>class_exists('SCFS_Connected_Support_Operations'),'detail'=>'Unified operational health, product dossiers, governed action queue, snapshots, and integrity-protected reports'),
    ...
    private function counts() {
        ...
        return array(
            ...
            'platform_incidents'=>post_type_exists('sc_platform_incident')?$this->count_posts('sc_platform_incident'):0,
    ...
    private function snapshot() {
        return array('ok'=>true,'platform'=>'Sustainable Catalyst Product Support and Feedback Platform','version'=>self::VERSION,'generated_at'=>gmdate('c'),'counts'=>$this->counts(),'readiness'=>$this->readiness(),'governance'=>array_diff_key($this->settings(),array('enable_retention_actions'=>true)),'event_schema_version'=>Sustainable_Catalyst_Feature_Suggestions::EVENT_SCHEMA_VERSION,'canonical_product_registry'=>class_exists('SCFS_Canonical_Product_Registry')?SCFS_Canonical_Product_Registry::instance()->schema_record():array(),'canonical_product_registry_summary'=>class_exists('SCFS_Canonical_Product_Registry')?SCFS_Canonical_Product_Registry::instance()->summary_record():array(),'product_taxonomy'=>class_exists('SCFS_Product_Integration')?SCFS_Product_Integration::instance()->taxonomy_schema():array(),'product_coverage'=>class_exists('SCFS_Product_Integration')?SCFS_Product_Integration::instance()->coverage():array(),'knowledge_base'=>class_exists('SCFS_Knowledge_Base_Foundation')?SCFS_Knowledge_Base_Foundation::instance()->schema_record():array(),'guided_resolution'=>class_exists('SCFS_Guided_Resolution')?SCFS_Guided_Resolution::instance()->schema_record():array(),'guided_resolution_handoff'=>class_exists('SCFS_Guided_Resolution')?SCFS_Guided_Resolution::instance()->handoff_schema():array(),'contact_engagement_handoff'=>class_exists('SCFS_Product_Integration')?SCFS_Product_Integration::instance()->handoff_schema():array(),'product_support_platform'=>class_exists('SCFS_Product_Support_Platform')?SCFS_Product_Support_Platform::instance()->schema_record():array(),'release_intelligence'=>class_exists('SCFS_Product_Support_Platform')?SCFS_Product_Support_Platform::instance()->overview_record(''):array(),'editorial_governance'=>class_exists('SCFS_Editorial_Governance')?SCFS_Editorial_Governance::instance()->schema_record():array(),'editorial_governance_summary'=>class_exists('SCFS_Editorial_Governance')?SCFS_Editorial_Governance::instance()->governance_summary():array(),'support_reliability'=>class_exists('SCFS_Support_Reliability_Center')?SCFS_Support_Reliability_Center::instance()->schema_record():array(),'support_reliability_dashboard'=>class_exists('SCFS_Support_Reliability_Center')?SCFS_Support_Reliability_Center::instance()->dashboard_record(''):array(),'cross_product_orchestration'=>class_exists('SCFS_Cross_Product_Support_Orchestration')?SCFS_Cross_Product_Support_Orchestration::instance()->schema_record():array(),'cross_product_overview'=>class_exists('SCFS_Cross_Product_Support_Orchestration')?SCFS_Cross_Product_Support_Orchestration::instance()->overview_record(''):array(),'connected_support_operations'=>class_exists('SCFS_Connected_Support_Operations')?SCFS_Connected_Support_Operations::instance()->schema_record():array(),'connected_operations_dashboard'=>class_exists('SCFS_Connected_Support_Operations')?SCFS_Connected_Support_Operations::instance()->dashboard_record():array(),'human_review_required'=>true);
    }
