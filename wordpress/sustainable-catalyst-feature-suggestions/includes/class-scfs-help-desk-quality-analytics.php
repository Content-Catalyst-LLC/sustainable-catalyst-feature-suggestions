...
final class SCFS_Help_Desk_Quality_Analytics {
    ...
    public function register_assets() {
        wp_register_style('scfs-help-desk-quality-analytics', plugins_url('../assets/help-desk-quality-analytics-v6.9.0.css', __FILE__), array(), self::VERSION);
        wp_register_script('scfs-help-desk-quality-analytics', plugins_url('../assets/help-desk-quality-analytics-v6.9.0.js', __FILE__), array(), self::VERSION, true);
    }
