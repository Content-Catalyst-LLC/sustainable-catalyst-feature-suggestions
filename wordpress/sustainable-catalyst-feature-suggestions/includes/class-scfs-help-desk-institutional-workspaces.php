...
final class SCFS_Help_Desk_Institutional_Workspaces {
    ...
    public function admin_assets($hook) {
        ...
        wp_enqueue_style('scfs-help-desk-institutional-workspaces', plugins_url('../assets/help-desk-institutional-workspaces-v6.10.0.css', __FILE__), array(), self::VERSION);
        wp_enqueue_script('scfs-help-desk-institutional-workspaces', plugins_url('../assets/help-desk-institutional-workspaces-v6.10.0.js', __FILE__), array(), self::VERSION, true);
    }
