...
final class SCFS_Opportunity_Workflow {
    ...
    public function render_meta($post) {
        ...
        echo '<p><label><strong>'.esc_html__('Target release','sustainable-catalyst-feature-suggestions').'</strong><br><input class="widefat" name="scfs_target_release" value="'.esc_attr($target).'" placeholder="v3.2.0"></label></p>';
