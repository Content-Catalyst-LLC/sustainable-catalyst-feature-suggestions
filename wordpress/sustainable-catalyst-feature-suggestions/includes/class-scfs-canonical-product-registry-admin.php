...
final class SCFS_Canonical_Product_Registry_Admin {
    ...
    public function enqueue_assets($hook_suffix) {
        ...
        wp_enqueue_style('scfs-canonical-product-registry-admin-v770', $base . 'canonical-product-registry-admin-v7.7.0.css', array(), self::VERSION);
        wp_enqueue_script('scfs-canonical-product-registry-admin-v770', $base . 'canonical-product-registry-admin-v7.7.0.js', array(), self::VERSION, true);
    }
