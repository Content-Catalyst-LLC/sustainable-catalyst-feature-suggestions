...
REPO_ARCHIVE="sustainable-catalyst-product-support-feedback-v7.2.0-repository.zip"
BUNDLE_ARCHIVE="sustainable-catalyst-product-support-feedback-platform-v7.2.0-release-bundle.zip"
SUMS_ARCHIVE="sustainable-catalyst-product-support-feedback-v7.2.0-artifacts.sha256"
...
if [ "${SCPSF_PREFLIGHT_ONLY:-0}" = "1" ]; then
  printf 'PREFLIGHT PASSED: selected the v7.2.0 installed plugin discovery release and preserved the WordPress plugin identity.\n'
  exit 0
fi
