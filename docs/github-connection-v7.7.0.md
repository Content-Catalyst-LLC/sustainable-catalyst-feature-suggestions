# GitHub Connection v7.7.0

The GitHub Connection screen remains the credential and repository-test surface. v7.7.0 improves the records consumed by that screen and Release Operations.
