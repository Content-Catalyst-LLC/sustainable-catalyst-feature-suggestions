# Plugin Discovery Intelligence v7.7.1

Plugin Discovery Intelligence classifies every WordPress plugin implementation and connects its evidence to the Canonical Product Registry without creating products automatically.
