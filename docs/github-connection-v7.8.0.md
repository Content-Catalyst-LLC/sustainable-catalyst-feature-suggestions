# GitHub Connection v7.8.0

The GitHub Connection screen remains the credential and repository-test surface. v7.8.0 improves the records consumed by that screen and Release Operations.
