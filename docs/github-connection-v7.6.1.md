...
The GitHub Connection screen remains the credential and repository-test surface. v7.6.1 improves the records consumed by that screen and Release Operations.
