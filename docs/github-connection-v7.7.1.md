# GitHub Connection v7.7.1

The GitHub Connection screen remains the credential and repository-test surface. v7.7.1 improves the records consumed by that screen and Release Operations.
